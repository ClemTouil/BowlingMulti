...
import clement.dhers.bowlingMulti.MultiP;
...
public class MultiPTest {
    ...
    @Before
    public void setUp() {
        playerName = new String[] {"Rémy", "Roger", "Clément"};
    }
    ...
    public void testGutterGame() throws Exception {
            rollMany(20, 0);
            assertEquals(0, game.scoreFor("Rémy"));
    }

    @Test
    public void testAllOnes() throws Exception {
            rollMany(20, 1);
            assertEquals(20, game.scoreFor("Rémy"));
    }
    ...
    public void testOneSpare() throws Exception {
            ...
            game.lancer(3); // 3
            rollMany(17, 0); // 0
            assertEquals(16, game.scoreFor("Rémy"));
    }
    ...
    public void testOneStrike() throws Exception {
            ...
            game.lancer(4);
            rollMany(16, 0);
            assertEquals(24, game.scoreFor("Rémy"));
    }
    ...
    public void testPerfectGame() throws Exception {
            ...
            rollMany(12, 10);
            assertEquals(300, game.scoreFor("Clément"));
    }
    ...
    public void testTypicalGame() throws Exception  {
            ...
            assertEquals(84, game.scoreFor("Roger"));
    }
